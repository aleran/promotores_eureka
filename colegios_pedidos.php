						...
						<div class="row">
							<div class="col-xs-12">
								...
								<?php 
                                	...
                                	$sql = "SELECT c.id, c.codigo, c.colegio, c.direccion, c.barrio,c.telefono FROM colegios c JOIN presupuestos p ON c.id=p.id_colegio WHERE c.cod_zona='".$_SESSION["zona"]."' AND p.definido='1' AND p.id_periodo='".$gp_periodo["id"]."' GROUP BY c.id";
									$req = $bdd->prepare($sql);
									$req->execute();
