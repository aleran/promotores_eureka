...
<meta name="theme-color" content="#52004F">
		<meta charset="utf-8" />
		<title>Registro de colegios</title>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Registro de colegios</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-sm-3">
								<!-- PAGE CONTENT BEGINS -->
									<form action="php/reg_colegios_pdf.php" method="POST">
									<div class="form-group">
										<label class="control-label no-padding-right" for="colegio"> Colegio:<small style="color:red;"> *</small> </label>
										<input required required type="text" name="colegio" id="colegio" placeholder="" class="form-control" autocomplete="off" onkeyup="busc_ms();bus_h()"/>
...
<![endif]-->
		...
		<script>
			...
			$(".registro_colegios").addClass("active");
		</script>
	</body>
</html>