						...
						<div class="row">
							<div class="col-xs-12">
								...
								<?php 
                                	...
                                	$sql = "SELECT p.id, z.zona, u.nombres, u.apellidos, p.fecha, c.colegio FROM muestreos p JOIN colegios c ON p.id_colegio=c.id JOIN zonas z ON z.codigo=c.cod_zona JOIN usuarios u ON u.cod_zona=z.codigo WHERE p.estado='3' GROUP BY p.id";
									$req = $bdd->prepare($sql);
									$req->execute();
                                        ...
                                        <?php 
                                        	foreach($pedidos as $pedido) {
                                               ...
                                               echo'<td class="center">'.$pedido["zona"].'</td>';
                                                ...
                                                echo'<td class="center"><a href="muestreo_colegio_anulado.php?id_pedido='.$pedido["id"].'">'.$pedido["colegio"].'</a></td>';
