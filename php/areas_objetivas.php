		...
		foreach ($_POST["libs_ao"] as $libros => $libro) {
			...
			$codigos = $req->fetchAll();
	         ...
	         foreach($codigos as $codigo) {
				if ($cod_area !="") {
					...
					$sql_p="INSERT INTO areas_objetivas(codigo,id_periodo,id_colegio,id_materia,id_grado,id_grado_otro,id_libro_eureka) VALUES('".$cod_area."','".$gp_periodo["id"]."','".$_POST["id_colegio"]."', '".$materia."', '".$grado."','".$grado_otro."', '".$lib."')";
			...
			elseif ($grado == 17) {
				...
				if ($lib !=0) {
					...
					$sql_e = "INSERT INTO presupuestos(id_periodo,id_colegio, id_libro,cod_area,  precio, tasa_compra,descuento) values ('".$gp_periodo["id"]."','".$_POST["id_colegio"]."','".$lib."','".$cod_area."','0', '0', '0.20')";
