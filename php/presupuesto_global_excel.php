...
foreach($presupuestos as $presupuesto) {
    ...
    $conta_cols3 = array_search($cols[$presupuesto["fila"]], $cols2);
      ...
      $objPHPExcel->getActiveSheet()->SetCellValue($cols[$presupuesto["fila"]].$col_final, "$ac[total_poblacion]");
      $objPHPExcel->getActiveSheet()->SetCellValue($cols[$presupuesto["fila"]+1].$col_final, "$ac[total_tasa]");
