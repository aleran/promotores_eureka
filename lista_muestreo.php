...
<html lang="es">
	<head>
		...
		<meta charset="utf-8" />
		<title>Muestreo pendientes</title>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<?php 
                                	...
                                	$sql = "SELECT p.id, z.zona, u.nombres, u.apellidos, p.fecha, c.colegio FROM muestreos p JOIN colegios c ON p.id_colegio=c.id JOIN zonas z ON z.codigo=c.cod_zona JOIN usuarios u ON u.cod_zona=z.codigo WHERE p.estado='1' GROUP BY p.id";
									$req = $bdd->prepare($sql);
									$req->execute();
