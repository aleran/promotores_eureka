				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							...
							<?php
								$sql_z = "SELECT colegio FROM colegios WHERE id='".$_GET['id_colegio']."'";
								$req_z = $bdd->prepare($sql_z);
								$req_z->execute();
								$zona = $req_z->fetch();
								echo "<div class='pull-right' style='font-size: 20px;'>". $zona["colegio"]."</div>";
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<?php 
                                	...
                                	$sql = "SELECT l.id, l.id_grado, l.libro, p.tasa_compra_d, m.materia, p.cod_area FROM libros l JOIN presupuestos p ON l.id=p.id_libro JOIN materias m ON l.id_materia=m.id WHERE p.id_colegio='".$_GET["id_colegio"]."' AND p.id_periodo='".$_GET["periodo"]."' AND p.definido='1' ";
									$req = $bdd->prepare($sql);
									$req->execute();
                                    ...
                                    <tbody>
                                        ...
                                        <?php 
											...
											if ($go["id_grado_otro"] == 0) {
												...
												$sql_alm = "SELECT alumnos FROM grados_paralelos WHERE id_grado='".$libro["id_grado"]."' AND id_periodo='".$_GET["periodo"]."' AND id_colegio='".$_GET["id_colegio"]."'";
												...
												$sql_alm = "SELECT alumnos FROM grados_paralelos WHERE id_grado='".$go["id_grado_otro"]."' AND id_periodo='".$_GET["periodo"]."' AND id_colegio='".$_GET["id_colegio"]."'";
