						...
						<div class="row">
							<div class="col-xs-12">
								...
								<?php 
                                	...
                                	$sql = "SELECT c.id, c.codigo, c.colegio, c.direccion, c.barrio,c.telefono FROM colegios c JOIN areas_objetivas p ON c.id=p.id_colegio WHERE c.cod_zona='".$_SESSION["zona"]."' AND p.id_periodo='".$gp_periodo["id"]."' GROUP BY c.id";
									$req = $bdd->prepare($sql);
									$req->execute();
                                        ...
                                        <?php 
                                        	foreach($colegios as $colegio) {
                                              ...
                                              $periodo2 = $gp_periodo["id"];
                                                ...
                                                echo'<td class="center"><a href="solicitar_muestras.php?id_colegio='.$id.'&periodo='.$periodo2.'">'.$nombre.'</a></td>';
