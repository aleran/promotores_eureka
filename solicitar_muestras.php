...
<meta name="theme-color" content="#52004F">
		<meta charset="utf-8" />
		<title>Solicitar muestras</title>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Solicitar muestras</li>
						</ul><!-- /.breadcrumb -->
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<?php 
                                	...
                                	$sql = "SELECT l.id, l.id_grado, l.libro, m.materia, p.codigo FROM libros l JOIN areas_objetivas p ON l.id=p.id_libro_eureka JOIN materias m ON l.id_materia=m.id WHERE p.id_colegio='".$_GET["id_colegio"]."' AND p.id_periodo='".$_GET["periodo"]."' GROUP BY l.id";
									$req = $bdd->prepare($sql);
									$req->execute();
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                        				...
                        				<form action="php/muestreo.php" method="POST">
                                        <?php 
                                        	foreach($libros as $libro) {
                                            	
                                            $sql_go = "SELECT id_grado_otro FROM areas_objetivas WHERE codigo='".$libro["codigo"]."'";
