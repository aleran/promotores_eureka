						...
						<div class="row">
							<div class="col-xs-12">
                                ...
                                if ($_SESSION["tipo"]==1) {
									...
									$sql = "SELECT t.id, t.tipo, c.codigo, c.colegio, n.id_periodo, n.id as id_notifi FROM notificaciones n JOIN tipos_notifi t ON t.id=n.id_tipo_notifi JOIN colegios c ON c.id=n.id_colegio WHERE t.id > 1 AND n.visible='1' AND c.cod_zona='".$_SESSION["zona"]."'";
                                    ...
                                    <tbody>
                                        <?php 
                                        	foreach($notificaciones as $notificacion) {
                                                ...
                                                echo'<td class="center">'.$notificacion["colegio"].'</td>';
                                                if ($_SESSION["tipo"]==1) {
                                                	echo'<td class="center"><a href="colegio.php?codigo='.$notificacion["codigo"].'&periodo='.$notificacion["id_periodo"].'">'.$notificacion["tipo"].'</a></td>';
                                            	}else {
                                            		echo'<td class="center"><a href="colegio.php?codigo='.$notificacion["codigo"].'&periodo='.$notificacion["id_periodo"].'&notifi='.$notificacion["id_notifi"].'">'.$notificacion["tipo"].'</a></td>';
                                            	}
                                            }
